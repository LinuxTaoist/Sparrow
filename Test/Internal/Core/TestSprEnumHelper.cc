...
TEST(Core_SprEnumHelper, GetSprErrorLevelDescription) {
    EXPECT_EQ(InternalDefs::GetSprErrorLevelDescription(SprErrorLevel::ERR_EVENT_LEVEL_UNKNOWN), "ERR_EVENT_LEVEL_UNKNOWN");
    EXPECT_EQ(InternalDefs::GetSprErrorLevelDescription(SprErrorLevel::ERR_EVENT_LEVEL_CRITICAL), "ERR_EVENT_LEVEL_CRITICAL");
    EXPECT_EQ(InternalDefs::GetSprErrorLevelDescription(SprErrorLevel::ERR_EVENT_LEVEL_ERROR), "ERR_EVENT_LEVEL_ERROR");
    EXPECT_EQ(InternalDefs::GetSprErrorLevelDescription(SprErrorLevel::ERR_EVENT_LEVEL_WARNNING), "ERR_EVENT_LEVEL_WARNNING");
    EXPECT_EQ(InternalDefs::GetSprErrorLevelDescription(SprErrorLevel::ERR_EVENT_LEVEL_INFO), "ERR_EVENT_LEVEL_INFO");
    EXPECT_EQ(InternalDefs::GetSprErrorLevelDescription(SprErrorLevel::ERR_EVENT_LEVEL_BUTT), "ERR_EVENT_LEVEL_BUTT");
    EXPECT_EQ(InternalDefs::GetSprErrorLevelDescription(SprErrorLevel::ERR_EVENT_LEVEL_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprErrorDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprErrorDescription(CommonErrorCode::ERR_SHM_GET_SIZE_FAILED), "Failed to get shared memory size");
...
TEST(Core_SprEnumHelper, GetSprProxTypeDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprProxTypeDescription(InternalDefs::IPC_TYPE_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprModuleIDDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprModuleIDDescription(InternalDefs::MODULE_MAX + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprProxyBinderCmdDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprProxyBinderCmdDescription(InternalDefs::PROXY_CMD_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprPropertyBinderCmdDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprPropertyBinderCmdDescription(InternalDefs::PROPERTY_CMD_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprPowerMBinderCmdDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprPowerMBinderCmdDescription(InternalDefs::POWERM_CMD_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprDebugMBinderCmdDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprDebugMBinderCmdDescription(InternalDefs::DEBUG_MSG_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprOneNetBinderCmdDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprOneNetBinderCmdDescription(InternalDefs::ONENET_CMD_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprGeneralBinderCmdDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprGeneralBinderCmdDescription(InternalDefs::GENERAL_CMD_BUTT + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprModuleBootPriorityDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprModuleBootPriorityDescription(InternalDefs::BOOT_PRIORITY_LOWEST + 100), "UNDEFINED");
}
...
TEST(Core_SprEnumHelper, GetSprTimeSourceTypeDescription) {
    ...
    EXPECT_EQ(InternalDefs::GetSprTimeSourceTypeDescription(InternalDefs::TIME_SOURCE_TYPE_BUTT + 100), "UNDEFINED");
}

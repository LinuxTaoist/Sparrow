...
TEST(CUtil_SToI, NormalBigEndianUint8ProtocolCase) {
...
TEST(CUtil_SToI, NormalLittleEndianInt16ProtocolCase) {
...
TEST(CUtil_SToI, NormalBigEndianUint32WithOffsetProtocolCase) {
...
TEST(CUtil_SToI, CriticalOffsetNormalProtocolCase) {
...
// 协议异常：偏移为负数（非法协议解析偏移）
TEST(CUtil_SToI, NegativeOffsetErrorCase) {
    string str5 = "\x12\x34";
    uint16_t out5 = 0;
...
TEST(CUtil_SToI, NormalReadPartialFieldProtocolCase) {
...
// 协议异常：空协议包
TEST(CUtil_SToI, EmptyStringErrorCase) {
    string str7 = "";
    uint8_t out7 = 0;
...
TEST(CUtil_SToI, OverflowErrorProtocolCase) {
...
TEST(CUtil_SToI, SignedOverflowErrorProtocolCase) {
    string str9 = "\x80";
    int8_t out9 = 0;
...
TEST(CUtil_SToI, NormalLenEqualSizeProtocolCase) {
...
// 协议异常：len<0（非法参数）
TEST(CUtil_SToI, ErrorLenNegativeCase) {
    string str11 = "\x12";
    uint8_t out11 = 0;
...
TEST(CUtil_SToV, NormalBigEndianUint16BatchProtocolCase) {
...
TEST(CUtil_SToV, CoreAppendModeProtocolCase) {
...
TEST(CUtil_SToV, NormalLittleEndianInt8WithOffsetProtocolCase) {
...
TEST(CUtil_SToV, CriticalRemainBytesNormalProtocolCase) {
...
// 协议异常：偏移为负数（非法协议头偏移）
TEST(CUtil_SToV, NegativeOffsetErrorCase) {
    string str4 = "\x12\x34";
...
TEST(CUtil_SToV, InsufficientBytesErrorProtocolCase) {
...
// 协议异常：空协议包
TEST(CUtil_SToV, EmptyStringErrorCase) {
    string str6 = "";
    vector<int32_t> out6;
...
TEST(CUtil_SToV, NormalLenSpecifiedProtocolCase) {
...
// 协议异常：len<0（非法参数）
TEST(CUtil_SToV, ErrorLenNegativeCase) {
...
TEST(CUtil_IToS, NormalBigEndianUint8MaxProtocolCase) {
...
TEST(CUtil_IToS, NormalLittleEndianInt16MinProtocolCase) {
...
TEST(CUtil_IToS, NormalBigEndianUint64ZeroProtocolCase) {
...
TEST(CUtil_IToS, CoreCodecLoopProtocolCase) {
...
TEST(CUtil_IToV, NormalBigEndianUint8ToUint8MaxProtocolCase) {
...
// 协议场景：追加模式（协议字节流分段组装）
TEST(CUtil_IToV, CoreAppendModeProtocolCase) {
...
TEST(CUtil_IToV, NormalLittleEndianInt16ToInt16MinProtocolCase) {
...
TEST(CUtil_IToV, NormalBigEndianUint32ToUint8ProtocolCase) {
...
TEST(CUtil_IToV, OverflowErrorProtocolCase) {
...
TEST(CUtil_VToI, NormalBigEndianUint8ToUint32ProtocolCase) {
...
TEST(CUtil_VToI, NormalLittleEndianUint8ToInt16ProtocolCase) {
...
// 协议场景：跳过协议头后读取4字节字段
TEST(CUtil_VToI, CriticalOffsetNormalProtocolCase) {
...
// 协议异常：偏移为负数
TEST(CUtil_VToI, NegativeOffsetErrorCase) {
...
TEST(CUtil_VToI, NormalReadPartialFieldProtocolCase) {
...
// 协议异常：空字节流
TEST(CUtil_VToI, EmptyVectorErrorCase) {
    vector<uint8_t> in6;
    uint8_t out6 = 0;
...
// 协议场景：指定len等于字段长度
TEST(CUtil_VToI, NormalLenEqualSizeProtocolCase) {
...
TEST(CUtil_VToI, OverflowErrorProtocolCase) {
...
TEST(CUtil_VToI, CoreCodecLoopProtocolCase) {
...
TEST(CUtil_VToS, NormalBigEndianUint16ToEmptyStringProtocolCase) {
...
// 协议场景：追加模式（协议头+包体组装）
TEST(CUtil_VToS, CoreAppendModeProtocolCase) {
...
TEST(CUtil_VToS, NormalLittleEndianInt8ToNonEmptyStringProtocolCase) {
...
TEST(CUtil_VToS, CoreInputOffsetLenProtocolCase) {
...
// 协议异常：输入偏移为负数
TEST(CUtil_VToS, NegativeInputOffsetErrorCase) {
...
// 协议异常：空vector（无包体数据）
TEST(CUtil_VToS, EmptyVectorNormalCase) {
    vector<int32_t> in6;
    string out6 = "hello";
...
// 协议异常：输入len<0（非法参数）
TEST(CUtil_VToS, ErrorInputLenNegativeCase) {
...
TEST(CUtil_VToV, NormalBigEndianUint8ToUint16ProtocolCase) {
...
TEST(CUtil_VToV, CoreAppendModeProtocolCase) {
...
TEST(CUtil_VToV, NormalLittleEndianUint8ToUint16ProtocolCase) {
...
TEST(CUtil_VToV, NormalBigEndianUint8ToUint32ProtocolCase) {
...
// 协议场景：跳过协议头后读取批量字段
TEST(CUtil_VToV, NormalNonZeroOffsetBatchProtocolCase) {
...
// 协议场景：指定len读取部分批量字段
TEST(CUtil_VToV, NormalSpecifiedInMaxLenProtocolCase) {
...
// 协议异常：偏移为负数
TEST(CUtil_VToV, NegativeOffsetErrorCase) {
...
// 协议异常：inMaxLen为负数
TEST(CUtil_VToV, NegativeInMaxLenErrorCase) {
...
TEST(CUtil_VToV, NormalInt8ToInt16SignedProtocolCase) {
...
// 协议异常：空输入字节流
TEST(CUtil_VToV, EmptyInputVectorCase) {
    vector<uint8_t> in12;
...
TEST(CUtil_VToV, CoreCodecLoopProtocolCase) {

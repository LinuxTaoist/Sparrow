...
#define SPR_MODULE_ID_MACROS \
    ...
    ENUM_OR_STRING(MODULE_GB32960_MANAGER),     \
    ENUM_OR_STRING(MODULE_GB32960_DRIVER),      \
    ENUM_OR_STRING(MODULE_GB32960_LOGIN),       \
    ENUM_OR_STRING(MODULE_GB32960_LOGOUT),      \
    ENUM_OR_STRING(MODULE_GB32960_REALTIME),    \
    ENUM_OR_STRING(MODULE_GB32960_REISSUE),     \
    ENUM_OR_STRING(MODULE_GB32960_PLATFORM_LOGIN),\
    ENUM_OR_STRING(MODULE_GB32960_PLATFORM_LOGOUT),\
    ENUM_OR_STRING(MODULE_GB32960_HEARTBEAT),   \
    ENUM_OR_STRING(MODULE_GB32960_TIME_SYNC),   \
    ENUM_OR_STRING(MODULE_GB32960_ACTIVATE),    \
    ENUM_OR_STRING(MODULE_GB32960_ACTIVATE_ACK),\
    ENUM_OR_STRING(MODULE_GB32960_KEY_EXCHANGE),\

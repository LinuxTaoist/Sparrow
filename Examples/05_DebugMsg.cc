    ...
    do {
        ...
        switch(val) {
            case '0': {  // debug SprMsg
                ...
                theEnMsg.SetI8Value(-8);
                theEnMsg.SetU16Value(1616);
                theEnMsg.SetI16Value(-1616);
                theEnMsg.SetU32Value(3232);
                theEnMsg.SetI32Value(-3232);
                theEnMsg.SetU64Value(6464);
                theEnMsg.SetI64Value(-6464);
                ...
                SPR_LOGD("i16Value      : %d    \n", theDeMsg.GetI16Value());
                SPR_LOGD("u32Value      : %d    \n", theDeMsg.GetU32Value());
                SPR_LOGD("i32Value      : %d    \n", theDeMsg.GetI32Value());
                SPR_LOGD("u64Value      : %ld   \n", theDeMsg.GetU64Value());
                SPR_LOGD("i64Value      : %ld   \n", theDeMsg.GetI64Value());
